...
class RGBColor extends BaseColor{
  ...
  copy(obj) {
    if (obj instanceof RGBColor !== true) {
      console.error('Typeof parameter not RGBColor');
      return;
    }
    this.red = obj.red;
  ...
  /*========== Methods to set RGBColor Properties ==========*/
  ...
  getHSLA() {
    if (this.format === 'HSV') {
      let RGBColor = new RGBColor(this);
      RGBColor.setFormat('HSL');
      RGBColor.updateHSX();
      return RGBColor.getHSLA();
    }
    let a = '';
    let v = '';
